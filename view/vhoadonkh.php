...
<?php
	...
	$table = $p ->  lay1thanhtoankh($idtaikhoan);
		if($table){
			if(mysqli_num_rows($table)>0){
				...
				echo "<td style='color: white; text-align:center;border: 1px solid white;  background: #015f95;'>Tên khách hàng</td>";
				...
				while($row=mysqli_fetch_assoc($table)){
					echo "<tr>";
						...
						echo "<td style='border: 1px solid white; background: #ebecd0;'>";echo $row["HoTen"];echo "</td>";
